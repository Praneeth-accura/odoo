...
#         self._cr.execute("TRUNCATE report_export_xlsx CASCADE")
    ...
    def print_report_data(self):
        ...
        format31 = workbook.add_format({'font_size': 14, 'align': 'center', 'bold': True, 'bottom': True, 'right': True, 'left': True, 'top': True})
        ...
        worksheet.merge_range('A2:H2', 'Inventory Valuation Summary as of ' + str(date), format31)
        worksheet.merge_range('I2:L2', '', format31)
        ...
        if stock_type == 'loc':
            ...
            worksheet.write(4, 4, 'Category', format21)
            worksheet.write(4, 5, 'Cost Price', format21)
            worksheet.write(4, 6, 'Sales Price', format21)
            ...
            for i in locations[1]:
                ...
                for each in get_line:
                    ...
                    worksheet.write(prod_row, prod_col + 4, each['category'], font_size_8)
                    worksheet.write(prod_row, prod_col + 5, each['cost_price'], font_size_8)
                    worksheet.write(prod_row, prod_col + 6, each['list_price'], font_size_8)
    ...
    def generate_xlsx_report(self):
        ...
        format1.set_align('center')
        red_mark.set_align('center')
        sheet.merge_range('A2:H2', 'Inventory at Date: ' + str(date), format31)
        sheet.merge_range('I2:L2', '', format31)
        ...
        if stock_type == 'loc':
            ...
            sheet.write(4, 4, 'Category', format21)
            sheet.write(4, 5, 'Cost Price', format21)
            sheet.write(4, 6, 'Sales Price', format21)
            ...
            for i in locations[1]:
                ...
                for each in get_line:
                    ...
                    sheet.write(prod_row, prod_col + 4, each['category'], font_size_8)
                    sheet.write(prod_row, prod_col + 5, each['cost_price'], font_size_8)
                    sheet.write(prod_row, prod_col + 6, each['list_price'], font_size_8)
