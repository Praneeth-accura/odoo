...
5) If you want to write backups to dropbox, create an app in dropbox and provide access token in the configuration.
""",

    'author': "Yenthe Van Ginneken,Technaureus Info Solutions",
